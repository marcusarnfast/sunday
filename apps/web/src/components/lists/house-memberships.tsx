...
import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from "@sunday/ui/components/table";
...
export function HouseMembershipsList({ preloadedMemberships }: HouseMembershipsListProps) {
