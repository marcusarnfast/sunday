...
const buttonVariants = cva(
  "cursor-default group whitespace-nowrap focus-visible:outline-hidden inline-flex items-center justify-center has-data-[arrow=true]:justify-between whitespace-nowrap text-sm font-medium ring-offset-background transition-[color,box-shadow,scale] disabled:pointer-events-none disabled:opacity-60 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
      ...
      mode: {
        default:
          "focus-visible:ring-2 focus-visible:ring-ring data-active:scale-[98%] data-active:duration-[10ms]",
        icon: "focus-visible:ring-2 focus-visible:ring-ring shrink-0",
        ...
        input: `
          ...
          `,
        card: "data-active:scale-[99.5%] data-active:duration-[10ms]",
      },
      placeholder: {
...
function Button({
  ...
  return (
    <HeadlessUIButton as={React.Fragment} type={props.type}>
