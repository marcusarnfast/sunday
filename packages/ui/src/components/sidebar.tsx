...
import { useIsMobile } from "@sunday/ui/hooks/use-mobile"
...
import {
  ...
  SheetHeader,
  SheetTitle,
} from "@sunday/ui/components/sheet"
...
import {
  ...
  TooltipProvider,
  TooltipTrigger,
} from "@sunday/ui/components/tooltip"
    ...
    <SidebarContext.Provider value={contextValue}>
      <TooltipProvider delayDuration={0}>
        <div
          ...
          className={cn(
            "group/sidebar-wrapper has-data-[variant=inset]:bg-sidebar flex min-h-svh w-full bg-red-500",
            className
          )}
          {...props}
        >
